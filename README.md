...
- CMake 3.5+ (3.14+ to build the tests or benchmarks)
...
- Library comparison report (`benchmark_results/benchmark_report.md`) -- scalar vs xsimd, tmech vs Eigen vs Fastor (generated locally by the scripts below)
...
Full documentation is available at https://tmech.readthedocs.io/
