...
public:
    ...
    template <typename U = data_type_LHS, typename V = data_type_RHS,
              std::enable_if_t<::tmech_detail::is_detected_v<has_direct_access_t, U>
                            && ::tmech_detail::is_detected_v<has_direct_access_t, V>, int> = 0>
    ...
    template <typename U = data_type_LHS, typename V = data_type_RHS,
              std::enable_if_t<::tmech_detail::is_detected_v<has_batch_access_t, U>
                            && ::tmech_detail::is_detected_v<has_batch_access_t, V>, int> = 0>
