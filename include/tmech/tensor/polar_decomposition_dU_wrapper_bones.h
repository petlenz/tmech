...
****************************************************************************/
#ifndef POLAR_DECOMPOSITION_DU_WRAPPER_BONES_H
#define POLAR_DECOMPOSITION_DU_WRAPPER_BONES_H
...
public:
    ...
    polar_decomposition_dU_wrapper(_Base const & __base, _Tensor const& __dU)noexcept;

    polar_decomposition_dU_wrapper(polar_decomposition_dU_wrapper const & __data)noexcept;
...
#endif // POLAR_DECOMPOSITION_DU_WRAPPER_BONES_H
