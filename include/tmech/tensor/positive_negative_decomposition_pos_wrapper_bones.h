...
****************************************************************************/
#ifndef POSITIVE_NEGATIVE_DECOMPOSITION_POS_WRAPPER_BONES_H
#define POSITIVE_NEGATIVE_DECOMPOSITION_POS_WRAPPER_BONES_H
...
public:
    ...
    positive_negative_decomposition_pos_wrapper(Base const & __base, Tensor const& __R)noexcept;

    positive_negative_decomposition_pos_wrapper(positive_negative_decomposition_pos_wrapper const & __data)noexcept;
...
#endif // POSITIVE_NEGATIVE_DECOMPOSITION_POS_WRAPPER_BONES_H
