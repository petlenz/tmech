...
public:
    ...
    positive_negative_decomposition_pos_wrapper(Base const & __base, Tensor const& __R);

    positive_negative_decomposition_pos_wrapper(positive_negative_decomposition_pos_wrapper const & __data);
