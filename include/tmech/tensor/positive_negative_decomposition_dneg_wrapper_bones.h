...
****************************************************************************/
#ifndef POSITIVE_NEGATIVE_DECOMPOSITION_DNEG_WRAPPER_BONES_H
#define POSITIVE_NEGATIVE_DECOMPOSITION_DNEG_WRAPPER_BONES_H

namespace detail {

template <typename Base, typename Tensor>
class positive_negative_decomposition_dneg_wrapper : public tensor_base<positive_negative_decomposition_dneg_wrapper<Base, Tensor>>
{
    using basetype = tensor_base<positive_negative_decomposition_dneg_wrapper<Base, Tensor>>;
public:
...
#endif // POSITIVE_NEGATIVE_DECOMPOSITION_DNEG_WRAPPER_BONES_H
