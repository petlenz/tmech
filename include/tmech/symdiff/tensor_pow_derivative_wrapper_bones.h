...
****************************************************************************/
#ifndef TENSOR_POW_DERIVATIVE_WRAPPER_BONES_H
#define TENSOR_POW_DERIVATIVE_WRAPPER_BONES_H

namespace detail {

template <typename _Father>
class tensor_pow_wrapper_derivative : public variable_base<tensor_pow_wrapper_derivative<_Father>>
{
    friend class variable_base<tensor_pow_wrapper_derivative<_Father>>;
public:
...
#endif // TENSOR_POW_DERIVATIVE_WRAPPER_BONES_H
