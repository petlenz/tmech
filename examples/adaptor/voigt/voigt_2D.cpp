...
int main() {
    ...
    tmech::adaptor<double, 2, 4, tmech::voigt<2>> C(ptrC);
    tmech::adaptor<double, 2, 2, tmech::voigt<2>> sig(ptrSig);
    tmech::adaptor<double, 2, 2, tmech::voigt<2, true>> eps(ptrEps);
