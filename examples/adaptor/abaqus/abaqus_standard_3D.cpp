...
int main() {
    ...
    tmech::adaptor<double, 3, 4, tmech::abq_std<3>> C(ptrC);
    tmech::adaptor<double, 3, 2, tmech::abq_std<3>> sig(ptrSig);
    tmech::adaptor<double, 3, 2, tmech::abq_std<3,true>> eps(ptrEps);
